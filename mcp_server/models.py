...
class CertificateParameters(BaseModel):
    ...
    lino: str = Field(..., description='Licence No', examples=['SAS2F2803'])
...
class AlsfcCertificatePostRequest(BaseModel):
...
class AlsfcCertificatePostResponse(BaseModel):
...
class AlsfcCertificatePostResponse1(BaseModel):
...
class AlsfcCertificatePostResponse2(BaseModel):
...
class AlsfcCertificatePostResponse3(BaseModel):
...
class AlsfcCertificatePostResponse4(BaseModel):
...
class AlsfcCertificatePostResponse5(BaseModel):
...
class AlsfcCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class ClcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class ClcerCertificatePostResponse(BaseModel):
...
class ClcerCertificatePostResponse1(BaseModel):
...
class ClcerCertificatePostResponse2(BaseModel):
...
class ClcerCertificatePostResponse3(BaseModel):
...
class ClcerCertificatePostResponse4(BaseModel):
...
class ClcerCertificatePostResponse5(BaseModel):
...
class ClcerCertificatePostResponse6(BaseModel):
    error: Optional[Error13] = None
    errorDescription: Optional[ErrorDescription13] = None


class SrcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class SrcerCertificatePostResponse(BaseModel):
...
class SrcerCertificatePostResponse1(BaseModel):
...
class SrcerCertificatePostResponse2(BaseModel):
...
class SrcerCertificatePostResponse3(BaseModel):
...
class SrcerCertificatePostResponse4(BaseModel):
...
class SrcerCertificatePostResponse5(BaseModel):
...
class SrcerCertificatePostResponse6(BaseModel):
